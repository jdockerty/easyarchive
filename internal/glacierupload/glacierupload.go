...
func CreateBucket() string{
    ...
    fmt.Println("An S3 bucket is not present, this will create a new one for you in the form of easyarchive-[random_ID_suffix].")
...
// UploadArchive will upload the .zip into S3 Glacier.
